...
const perguntas = [
    {
        ...
        alternativas: [
            ...
            },
            {
                ...
                afirmacao: "Quis descobrir como utilizar a tecnologia em diferentes situações do seu dia a dia."
            }
        ]
    },
    {
        ...
        alternativas: [
            {
                ...
                afirmacao: "Conseguiu utilizar a IA para encontrar informações úteis e desenvolver uma solução para a escola."
            },
            {
                ...
                afirmacao: "Sentiu mais facilidade em utilizar seus próprios conhecimentos para desenvolver sua solução."
            }
        ]
    },
    {
        ...
        alternativas: [
            {
                ...
                afirmacao: "Vem buscando aprender mais sobre IA e luta para abrir novos caminhos profissionais utilizando a tecnologia."
            },
            {
                ...
                afirmacao: "Sua preocupação com as pessoas motivou a criar um grupo de estudos para discutir formas de utilizar IA de maneira ética."
            }
        ]
    },
    {
        ...
        alternativas: [
            {
                ...
                afirmacao: "Notou também que muitas pessoas ainda não sabem utilizar ferramentas tradicionais e decidiu compartilhar seus conhecimentos de desenho digital."
            },
            {
                texto: "Criar uma imagem utilizando um gerador de imagens com Inteligência Artificial.",
                afirmacao: "Acelerou o processo de criação utilizando geradores de imagem e agora consegue ensinar pessoas que sentem dificuldades em desenhar."
            }
        ]
    },
    {
        ...
        alternativas: [
            {
                ...
                afirmacao: "Infelizmente passou a utilizar a IA para fazer todas suas tarefas e agora se sente dependente da tecnologia para tudo."
            },
            {
                ...
                afirmacao: "Percebeu que os textos gerados pela IA podem apresentar erros e opiniões que não refletem o que pensava, por isso utiliza a ferramenta apenas como auxílio."
            }
        ]
    },
]
